...
public class RetreatBeforeShock extends UnitAbstractAction {

    public RetreatBeforeShock(LoadTable table, WarriorInCombat warrior) throws IOException, CsvException {
        mWarrior = warrior;
        mTitle = "Retreat before Shock";
        mTitleId = R.string.retreat_before_shock;
